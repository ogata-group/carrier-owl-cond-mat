...
def notify(results: list, template: str, slack_id: str, line_token: str) -> None:
    ...
    for result in results:
        ...
        text = Template(template).substitute(article_str, words=words, score=score,
                                             title_trans=title_trans, summary_trans=summary_trans, star=star)
...
def main():
    ...
    articles = arxiv.query(query=arxiv_query, max_results=1000,
                           sort_by='submittedDate', iterative=False)
